 ...
 * @description Configuration for the Certifications page, displaying licenses, awards, and achievements organized by category.
 */
export interface Certifications extends BasePageConfig {
  /** List of certifications organized by category */
  certifications: Array<{
    /** Category of certification: skill-based, award, or volunteer */
    category: "keahlian" | "penghargaan" | "volunteer";
    /** Title of the certification */
    title: string;
    /** Issuing organization or body */
    issuer: string;
    /** Date when certification was issued */
    date: string;
    /** Brief description of the certification (1 paragraph) */
    description: React.ReactNode;
    /** Image/badge URL for the certification */
    image?: string;
    /** Image alt text */
    imageAlt?: string;
    /** Link to verify or view the certification */
    link?: string;
  }>;
}
